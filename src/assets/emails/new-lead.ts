                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td valign="top" style="border: 2rem solid #fff; text-align: center; font-family: 'Montserrat', sans-serif !important;">
                                                    <strong style="font-family: 'Montserrat', sans-serif !important;">Urgent Response Required:</strong>
                                                </br> 
                                                
                                                <span style="margin-top: 0.5rem !important; display: block;">A customer has just submitted a request for General Restaurant Equipment!</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>   
                                                <td align="center" valign="top">
                                                    <table align="center" style="margin-bottom: 30px;">
                                                        <tr>
                                                          <td align="center">
                                                            <a href="https://admin.carybit.com/leads/${leadId}" target="_blank" style="background-color: #eb2127; color: #ffffff; padding: 14px 25px; text-align: center; font-weight: 500; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 40px; font-family: 'Montserrat', sans-serif !important;">
                                                                View Lead Details
                                                            </a>
                                                          </td>
                                                        </tr>
